...
import Pasta1 from "../Pasta1.jpeg"
import Pasta2 from "../Pasta2.jpeg"
...
export default function Biscoitos() {
    ...
    <BoxConteinerUm>
    <Box onClick={zoom}>
    <img src={Pasta1} alt="biscoito" style={{ transform: zoomed ? 'scale(2)' : 'scale(1)' }} />
    <h2>Defumadas</h2>
    <h3>R$ 18,00</h3>
    </Box>

    <Box onClick={zoom2}>
    <img  src={Pasta2} alt="biscoito" style={{ transform: zoomed2 ? 'scale(2)' : 'scale(1)' }} />
    <h2>Tradicionais</h2>
    <h3>R$ 15,00</h3>
    </Box>
